...
public static class AppText
{
    ...
    public static string ExtendedPalette => Get(nameof(ExtendedPalette));
    public static string PaletteHelp => Get(nameof(PaletteHelp));
    public static string CustomColor => Get(nameof(CustomColor));
    public static string ColorSpectrum => Get(nameof(ColorSpectrum));
    public static string SpectrumKeyboardHelp => Get(nameof(SpectrumKeyboardHelp));
    public static string ColorValues => Get(nameof(ColorValues));
    public static string InvalidColorValue => Get(nameof(InvalidColorValue));
    public static string CurrentColor => Get(nameof(CurrentColor));
    public static string NewColor => Get(nameof(NewColor));
    public static string Cancel => Get(nameof(Cancel));
    public static string Color => Get(nameof(Color));
    public static string GradientType => Get(nameof(GradientType));
    ...
    public static string StopColor => Get(nameof(StopColor));
    public static string StopPosition => Get(nameof(StopPosition));
    public static string GradientRailHelp => Get(nameof(GradientRailHelp));
    public static string InvalidGradientDefinition => Get(nameof(InvalidGradientDefinition));
