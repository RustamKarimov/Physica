...
System-wide topology and ownership map.

## Scope

Apps/packages, layers, shared services and major runtime flow.
...
- keep core portable between desktop and web viewer

## This subsystem MUST NOT

- duplicate state between React and core store
- let renderers calculate domain physics
