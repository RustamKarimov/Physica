...
Owns dependency/font/asset license metadata and redistribution gates.

## Scope

Bundled libraries, fonts, visual assets, examples and export runtime.
...
- track license/provenance for every bundled asset/dependency
- use redistributable deterministic fonts

## This subsystem MUST NOT

- ship incompatible/restricted assets
