...
| Themes, slide backgrounds, size, orientation, margins, and safe-area values | UI wired | Commit 979f77a adds a contextual Slide Design inspector, project themes, per-slide theme/solid/gradient backgrounds, transparency, size presets/custom dimensions, orientation, two explicit resize policies, and editable insets. Focused checks prove atomic history, serialization, shared snapshots, model-transform preservation, nested-group single scaling, and guide relocation/clamping. The real launcher is responsive, but Computer failed before observation after reset and retry | Teacher review of Design routing, inspector readability, theme/background/editor/thumbnail/presenter agreement, both resize policies, grouped content, overlay agreement, undo/redo, and save/reopen |
