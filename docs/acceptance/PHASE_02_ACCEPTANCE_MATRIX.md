...
| Themes, slide backgrounds, size, orientation, margins, and safe-area values | UI wired — blocking visual failure | Themes now recolour the built-in lesson correctly, but the third teacher review found the custom quick palette visually unacceptable: intended square swatches collapsed into narrow lines, recent colours and a professional advanced workflow were absent, and the exposed exact-entry card still dominated ordinary selection. The corrected two-level Physica colour workflow must be implemented and reviewed before this row can advance. | Teacher review of the closed colour field; filled theme shade matrix; standard and recent colours; separate Standard/Custom advanced chooser; keyboard and pointer behavior; obvious whole-slide theme changes; custom-background override action; and editor/thumbnail agreement |
