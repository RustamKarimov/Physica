...
Owns physical/world/reference/view/camera/layout/data/image coordinate semantics.

## Scope

2D/3D conventions, reference frames, educational visual scale and transforms.
...
- use right-handed 3D physical convention
- keep physical and layout coordinates distinct

## This subsystem MUST NOT

- infer physical position from screen coordinates without explicit transform
