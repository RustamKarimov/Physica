# Serialization and Project Package
...
Owns `.physica` package structure, schema validation, stable asset addressing and atomic persistence semantics.

## Scope

ZIP package, manifest/project/assets/datasets/plugin-data, IDs and checksums.
...
- store project as source of truth
- preserve unknown plugin payloads

## This subsystem MUST NOT

- use local app DB as project truth
- trust unsafe ZIP paths
